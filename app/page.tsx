...
async function getStripeProducts(): Promise<StripeProduct[]> {
  // Stripe disabled: return empty list for now
  return [];
}
    ...
    <div className="flex min-h-[100dvh] flex-col">
      <header className="fixed flex h-16 w-full items-center  border-b border-b-slate-200 bg-white px-4 lg:px-6">
        ...
        <nav className="ml-auto flex gap-4 sm:gap-6">
          ...
          <a className="text-sm font-medium underline-offset-4 hover:underline" href="#pricing">
            Pricing
          </a>
        </nav>
      ...
      <main className="flex-1">
        ...
        <section className="w-full bg-muted py-10 md:py-20 lg:py-32" id="features">
          <div className="container px-4 md:px-6">
            <h2 className="mb-4 text-center text-3xl font-bold tracking-tighter sm:text-5xl">
              Our Features
            </h2>
            <div className="grid gap-10 sm:grid-cols-2 md:grid-cols-3">
              <div className="flex flex-col items-center space-y-2 rounded-lg border-muted-foreground/10 p-4">
                ...
                <p className="text-center text-muted-foreground">
                  Seamlesly integrate Stripe Billing to capture subscription payments - Webhooks and
                  all
                </p>
              </div>
              <div className="flex flex-col items-center space-y-2 rounded-lg border-muted-foreground/10 p-4">
                ...
                <p className="text-center text-muted-foreground">
                  Utilize our preexisting Superbase integration to auth your users and secure your
                  app{' '}
                </p>
              </div>
              <div className="flex flex-col items-center space-y-2 rounded-lg border-muted-foreground/10 p-4">
            ...
            <div className="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <p className="mb-2 text-muted-foreground">
                    &quot;Wow everything is already integrated! Less time configuring, more time
                    building!.&quot;
                  </p>
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <p className="mb-2 text-muted-foreground">
                    &quot;We&aposve seen a 200% increase in productivity since implementing this
                    solution.&quot;
                  </p>
        ...
        <section className="w-full bg-muted py-10 md:py-20 lg:py-32" id="pricing">
          <div className="container px-4 md:px-6">
            <h2 className="mb-4 text-center text-3xl font-bold tracking-tighter sm:text-5xl">
              Pricing Plans
            </h2>
